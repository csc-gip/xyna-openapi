package com.gip.xyna.swagger.codegen;
...
public class Swagger2xynaxmomGenerator extends DefaultCodegen implements CodegenConfig {

  // source folder where to write the files
  protected String sourceFolder = "XMOM";
  protected String apiVersion = "1.0.0";
  protected String xynaFactoryVersion = "8.2.11.14";
  protected String xynaSwaggerVersion = "1.0.0";

  public static final String XYNA_FACTORY_VERSION = "xynaFactoryVersion";
  public static final String XYNA_SWAGGER_VERSION = "xynaSwaggerVersion";
  ...
  public String escapeUnsafeCharacters(String input) {
    ...
    return input.replace("&", "&amp;").replace("[CDATA", "[_CDATA")
        .replace(">", "&lt;").replace(">", "&gt;");
  }
  ...
  public String getHelp() {
    return "Generates a Swagger2XynaXMOM client library.";
  }

  public Swagger2xynaxmomGenerator() {
    super();

    // set the output folder here
    outputFolder = "generated-code/Swagger2XynaXMOM";
    ...
    additionalProperties.put(XYNA_SWAGGER_VERSION, xynaSwaggerVersion);
    ...
    cliOptions.add(
        new CliOption(CodegenConstants.API_PACKAGE,
    ...
    cliOptions.add(new CliOption(PROJECT_NAME,
        "name of the project (Default: generated from info.title or \"SwaggerXMOM\")"));
    cliOptions.add(new CliOption(MODULE_NAME,
        "module name (Default: generated from <projectName>)"));
    ...
    cliOptions.add(new CliOption(XYNA_SWAGGER_VERSION,
        "version of Xyna Swagger App to be used as base (Default: 1.0.0)"));
  }
  ...
  private void replaceComplexTypeForEnumByString(CodegenModel codegenModel, Map<String, CodegenModel> allModels) {
    ...
    for (CodegenProperty p : vars) {
      ...
      if (targetModel != null && targetModel.isEnum) {
        ...
        p.unescapedDescription = p.unescapedDescription + " " + "Converted to String from " + p.complexType + " Enum";
  ...
  public CodegenModel fromModel(String arg0, Model arg1, Map<String, Model> arg2) {
    ...
    // Mark all Swagger Objects
    if ("Object".equals(codegenModel.dataType)) {
      codegenModel.vendorExtensions.put("x-isSwaggerBaseType", true);
    }
